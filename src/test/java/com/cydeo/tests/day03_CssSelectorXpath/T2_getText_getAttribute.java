...
public class T2_getText_getAttribute {
    public static void main(String[] args) {
        ...
        String actualRememberMeLabel=rememberMeLabel.getText();//getText converts it to String

        if(actualRememberMeLabel.equals(expectedRememberMeLabel)){
            System.out.println("Remember me label verification PASSED!");
        }else{System.out.println("Remember me label verification FAILED!!!");
        ...
        if(actualForgotPasswordLinkText.equals(expectedForgotPasswordLinkText)){
            ...
            System.out.println("Forgot Password Link Verification FAILED!!!");//burada FAILED çıktı ve biz developer için yukarıdaki
            //iki print stat. ilave ettik!!
        }
