...
public class T1_DoubleClick {
    ...
    public void t1_double_click_test(){
       ...
       // doubleClickPage.textToDoubleClick.click(); //önce yazdı sonra sildi?
        actions.doubleClick(doubleClickPage.textToDoubleClick).perform();

        //4. Assert: Text’s “style” attribute value contains “red”.//getattribute ile çağırdık.soutv yaptık
